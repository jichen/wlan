	...
	<div class="pageFormContent" layoutH="56" align="left">
		<div>
			<dl class="nowrap">
				<dt>模板名称：</dt>
				<dd>
					<label style="width: 80px">${bean.templatename}</label>
					<input type="hidden" name="template_id"  value="${bean.id}" class="digits" readonly="readonly"/>
				</dd>
			</dl>
			<dl class="nowrap">
				<dt>终端类型：</dt>
			...
			<c:choose>
				...
				<c:forEach var="css" items="${list_css_mobile}"  varStatus="status">
					<dl class="nowrap">
						<dt>移动终端CSS式样${status.index+1}:</dt>
						<dd>
