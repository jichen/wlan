...
<script type="text/javascript">
	function dateScope() {
		var before = document.getElementById("radiusstartTime").value;
		var after = document.getElementById("radiusendTime").value;
	...
	<div class="searchBar">
		<table class="searchContent"  align="left" >
			<tr>
				...
				<td>
					<input id="radiusstartTime" name="startTime1"  class="date textInput" type="text"  size="20" value="${startTime}" readonly="readonly"><a href="javascript:;"></a>
					&nbsp;至&nbsp;
					<input id="radiusendTime" name="endTime1"  class="date textInput" type="text"  size="20" value="${endTime}"  readonly="readonly"/><a href="javascript:;"></a>
				</td>
				<td></td>
				<td>
				<div class="subBar">
