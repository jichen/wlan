...
public class DateUtil {
	...
	public static final String DATE_FORMAT_ABS = "yyMMdd";
	...
	public static String getFormatStringDate(Date d, String format) {
		if (d == null) {
			return "";
		}
	...
	// }
	public static Date getLastSecondOfDate(String str, String format) {
		SimpleDateFormat sdf = new SimpleDateFormat(format);
		if (StringUtils.isNotEmpty(str)) {
			try {
	 ...
	 * @return
	 */
	public static Date getEndDateOfMonth(Integer year, Integer month) {
		Calendar c = Calendar.getInstance();
		c.set(Calendar.YEAR, year);
		c.set(Calendar.MONTH, month - 1);
	...
	public static boolean compareDate(Date date1, Date date2) {
		String tmp1=formatDate(date1,DateUtil.DATE_FORMAT);
		String tmp2=formatDate(date2,DateUtil.DATE_FORMAT);
		date1=getDate(tmp1,DateUtil.DATE_FORMAT);
		date2=getDate(tmp2,DateUtil.DATE_FORMAT);
